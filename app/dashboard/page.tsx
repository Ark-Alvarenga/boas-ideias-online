        ...
        <div className="flex flex-col gap-8">
          ...
          >
            ...
            <div className="flex-1">
              ...
              {!hasProducts && (
                <p className="mt-2 text-base font-medium text-muted-foreground leading-relaxed">
                  Faça upload de um PDF ou guia e defina seu preço. Leva menos
                  de 2 minutos.
                </p>
              )}
              {hasProducts && (
            ...
            {!hasProducts && (
              <Button
                size="lg"
                className="h-14 rounded-2xl border-2 border-foreground bg-primary px-8 font-white text-white shadow-[4px_4px_0px_#000] transition-all hover:-translate-y-1 hover:shadow-[6px_6px_0px_#000] dark:shadow-[4px_4px_0px_#fff] dark:hover:shadow-[6px_6px_0px_#fff]"
                asChild
              >
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="mt-2 text-base font-medium text-muted-foreground leading-relaxed">
                Mande no Instagram, TikTok ou WhatsApp. Seu checkout está
                pronto.
              </p>
            </div>
            {hasProducts &&
